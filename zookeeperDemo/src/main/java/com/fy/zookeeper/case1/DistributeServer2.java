...
public class DistributeServer2 {
    ...
    private Logger logger = LoggerFactory.getLogger(DistributeServer2.class);
    ...
    public static void main(String[] args) throws Exception {
        DistributeServer2 distributeServer = new DistributeServer2();
        distributeServer.getConnection();
        distributeServer.registerServer("node2");
